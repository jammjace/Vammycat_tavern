export class BurnThermometer {
  constructor(scene) {
    ...
    this.label = scene.add.text(x + width / 2, y - 39, 'BURN', {fontFamily:'Real Chalk',letterSpacing:1.5,fontSize:'18px',color:'#f8e5ba'}).setOrigin(.5).setDepth(5110).setScrollFactor(0);
    this.makeScreenHeat();
